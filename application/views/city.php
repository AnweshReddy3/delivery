		...
		<article>
			...
			<div class="modal fade" id="add_city" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form method="post" action="<?php echo base_url("admin_controller/add_city/"); ?>" enctype="multipart/form-data">
							...
							<div class="modal-footer">
								...
								<button type="submit" name="insert_city" class="btn btn-primary">Submit</button>
							</div>
						</form>
					</div>
				</div>
			...
			<div class="container">
				<div class="add-category">
					...
					<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_city">
						Add Cities
					</button>
					<br>
					<br>
						...
						<table id="data-table" class="table table-hover table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="<?php echo base_url("admin_controller/fetch_id_city/".$row->id) ?>" class="btn btn-info">
											Edit
										</a>
										<a class="btn btn-danger" href="<?php echo base_url("admin_controller/delete_city/".$row->id) ?>">
											Delete
										</a>
									</td>
								</tr>
