...
<body>
		...
		<article>
			...
			<div class="container">
				<div class="add-category">
					<br>
					<div class="col-lg-4">
						<form action="<?php echo base_url("admin_controller/update_menu_item/" . $edit->id); ?>" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<label>Category</label>
								<select class="form-control" name="category">
									<option value="<?php echo $edit->item_category; ?>">
										<?php echo $edit->item_category ?>
									</option>
							...
							<div class="form-group">
								...
								<input type="text" name="item_name" value="<?php echo $edit->item_name; ?>" class="form-control" />
							</div>
							<div class="form-group">
								<label>Description</label>
								<textarea class="form-control" name="item_desc" id="myTextarea"></textarea>
							</div>
							<div class="form-group">
								<label>Price</label>
								<input type="text" name="item_price" value="<?php echo $edit->item_price; ?>" class="form-control" />
							</div>
							<div class="form-group">
								<img style="width:100px;height:100px;" src="<?php echo base_url("./assets/upload/images/".$edit->item_image); ?>">
							</div>
							<div class="form-group">
								<label>Image</label>
							...
							<br>
							<div class="form-group">
								<a href="<?php echo base_url(); ?>admin_controller/menu_item/" class="btn btn-primary">back</a>
	...
	<script>
		document.getElementById("myTextarea").value = "<?php echo $edit->item_desc; ?>";
