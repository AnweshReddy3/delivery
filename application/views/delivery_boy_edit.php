		...
		<article>
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin_controller/delivery_boy/">Delivery Boy</a></li>
			...
			<div class="container">
				<div class="add-category">
					...
					<br>
					<div class="col-md-4">
						<form method="post" action="<?php echo base_url("admin_controller/update_delivery_boy/" . $edit->id); ?>">
							<div class="form-group">
								<label>Name</label>
								<input type="text" name="boy_name" class="form-control" value="<?php echo $edit->name;?>" />
							</div>
							<div class="form-group">
								<label>Phone</label>
								<input type="text" name="boy_phone" class="form-control" value="<?php echo $edit->phone;?>" />
							</div>
							<div class="form-group">
								<label>Email</label>
								<input type="text" name="boy_email" class="form-control" value="<?php echo $edit->email;?>" />
							</div>
							<div class="form-group">
								<label>Password</label>
								<input type="text" name="boy_password" class="form-control" value="<?php echo $edit->password;?>" />
							</div>
							<div class="form-group">
								<label>vehicle No</label>
								<input type="text" name="boy_vehicle_no" class="form-control" value="<?php echo $edit->vehicle_no;?>" />
							</div>
							<div class="form-group">
								<label>vehicle Type</label>
								<input type="text" name="boy_vehicle_type" class="form-control" value="<?php echo $edit->vehicle_type;?>" />
							</div>
							<div class="form-group">
								<a class="btn btn-primary" href="<?php echo base_url(); ?>admin_controller/delivery_boy/">back</a>
