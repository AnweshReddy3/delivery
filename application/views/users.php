			...
			<div class="header-content">
				<nav class="navbar nav-expand-md navbar-light bg-light">
					...
					<div class="dropdown image dropleft">
						<img class="rounded-circle w-25 h-25 dropdown-toggle " id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" src="<?php echo base_url(); ?>assets/upload/profile/profile_pic.jpg"  alt="#"/>
							...
							<tbody>
								...
								if (isset($data)) {
									...
									<tr>
										...
										<td>
											<a class="btn btn-info" href="<?php echo base_url("admin_controller/delete_user/" . $row->id); ?>">Delete</a>
										</td>
									</tr>
									<?php
									}
