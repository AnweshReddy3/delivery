			...
			<div class="modal fade" id="add_cat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form method="post" action="<?php echo base_url(); ?>admin_controller/add_menu_category/" enctype="multipart/form-data">
							<div class="modal-body">
								<div class="form-group">
									<label>Category Name</label>
									<input type="text" name="cat_name" value="<?php echo set_value('cat_name'); ?>" class="form-control" Placeholder="Enter Category Name" />
									<?php echo form_error('cat_name'); ?>
								</div>
								<div class="form-group">
									<label>Category Icon</label>
									<input type="file" name="cat_icon" class="form-control-file" />
								</div>
							</div>
						...
						<table id="data-table" class="table table-hover table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<img alt="icon" src="<?php echo base_url("./assets/upload/images/".$row->category_icon); ?>" style="width: 60px; height: 60px;">
									</td>
									<td>
										<a href="<?php echo 
                                        base_url("admin_controller/fetch_id_category/".$row->id);  ?>" class="btn btn-info">
											Edit
										</a>
										<a class="btn btn-danger" href="<?php echo base_url("admin_controller/delete_category/".$row->id); ?>">
											Delete
										</a>
									</td>
								</tr>
