			...
			<div class="modal fade" id="add_contact" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form method="post" action="<?php echo base_url("admin_controller/add_contact/") ?>">
							<div class="modal-body">
								...
								<div class="form-group">
									<label>Phone</label>
									<input type="text" name="contact_phone" class="form-control" Placeholder="Enter Phone" />
								</div>
								<div class="form-group">
									<label>Message</label>
									<input type="text" name="contact_message" class="form-control" Placeholder="Enter Message" />
								</div>
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
								<button type="submit" name="insert_contact" class="btn btn-primary">Submit</button>
							</div>
						</form>
					</div>
				</div>
