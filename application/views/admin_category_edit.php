		...
		<article>
			...
			<div class="category">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin_controller/admin_category/">Category</a></li>
			...
			<div class="container">
				<div class="add-category">
					<br>
					<div class="col-lg-4">
						<form action="<?php echo base_url("admin_controller/update_category/". $edit->id); ?>" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<label>Category Name</label>
								<input type="text" name="cat_name" class="form-control" value="<?php echo $edit->category_name; ?>" />
							</div>
							<div class="form-group">
								<label>Category Icon</label>
								<img alt="icon" src="<?php echo base_url("./assets/upload/images/".$edit->category_icon); ?>" style="width: 100px; height: 100px;">
							</div>
							<div class="form-group">
								<input type="file" class="form-control" name="cat_icon" value="<?php echo base_url("./assets/upload/images/".$edit->category_icon); ?>" />
							</div>
							<br>
							<div class="form-group">
								<a href="<?php echo base_url(); ?>admin_controller/admin_category/" class="btn btn-primary">back</a>
