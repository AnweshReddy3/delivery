...
<body>
	...
	<div class="wrapper">
		...
		<article>
			...
			<!-- Modal for adding topping categories -->
			<div class="modal fade" id="add_top_cold" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">Add Toppings</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<form method="post" action="<?php echo base_url("admin_controller/add_topping/" . $id); ?>" enctype="multipart/form-data">
							<div class="modal-body">
								<div class="form-group">
									<label>Topping Name</label>
									<input type="text" class="form-control" name="top_name" Placeholder="Enter Topping Name" />
								</div>
								<div class="form-group">
									<label>Topping Price</label>
									<input type="text" class="form-control" name="top_price" Placeholder="Enter Topping Price" />
								</div>
							</div>
			...
			<div class="category">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin_controller/admin_top_cat/">Topping Category</a></li>
						<li class="breadcrumb-item active" aria-current="page">Topping</li>
					</ol>
				</nav>
			</div>
			<div class="container">
				<div class="add-category">
					...
					<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_top_cold">
						Add Toppings
					</button>
					<br>
					<br>
						...
						<table id="data-table" class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo $row->top_price; ?></td>
									<td>
										<a href="<?php echo base_url("admin_controller/fetch_id_topping_item/" . $row->id) ?>" class="btn btn-info">Edit</a>
										<a href="<?php echo base_url("admin_controller/delete_top/" . $row->id); ?>" class="btn btn-danger">Delete</a>
									</td>
								</tr>
								<?php $no++; ?>
								<?php
