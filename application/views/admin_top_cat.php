...
<body>
	...
	<div class="wrapper">
		...
		<article>
			...
			<div class="modal fade" id="add_top" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">Add Toppings Category</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<form method="post" action="<?php echo base_url(); ?>admin_controller/add_top_cat/" enctype="multipart/form-data">
							<div class="modal-body">
								<div class="form-group">
									<label>Category Name</label>
									<input type="text" class="form-control" name="top_cat" Placeholder="Enter Topping Category" />
								</div>
							</div>
			...
			<div class="category">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Topping Category</li>
					</ol>
				</nav>
			</div>
			<div class="container">
				<div class="add-category">
					...
					<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_top">
						Add Toppings Category
					</button>
					<br>
					<br>
					<div class="table">
						<table id="data-table" class="table table-hover table-striped">
							...
							<tbody>
								...
								<tr>
									<td><?php echo $no++; ?></td>
									<td><?php echo $row->top_cat; ?></td>
									<td>
										<a href="<?php echo base_url("admin_controller/fetch_id_top_cat/" . $row->id); ?>" class="btn btn-info">
											Edit
										</a>
										<a href="<?php echo base_url("admin_controller/admin_topping/" . $row->id); ?>" class="btn btn-warning">
											Toppings
										</a>
										<a class="btn btn-danger" href="<?php echo base_url("admin_controller/delete_top_cat/".$row->id); ?>">
											Delete
										</a>
									</td>
								</tr>
