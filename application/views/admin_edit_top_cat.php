		...
		<article>
			...
			<div class="container">
				<div class="add-category">
					<br>
					<div class="col-lg-4">
						<form action="<?php echo base_url("admin_controller/update_top_cat/" . $edit->id); ?>" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<input type="text" class="form-control" name="top_cat" value="<?php echo $edit->top_cat; ?>" />
							</div>
							<div class="form-group">
								<a href="<?php echo base_url(); ?>admin_controller/admin_top_cat/" class="btn btn-primary">back</a>
